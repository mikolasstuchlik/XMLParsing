...
open class XMLEncoder {
    ...
    open func encode<T : Encodable>(_ value: T, withRootKey rootKey: String, header: XMLHeader? = nil) throws -> Data {
        ...
        return element.toXMLString(with: header, withCDATA: stringEncodingStrategy != .deferredToString, ignoreEscaping: false, printPretty: outputFormatting.contains(.prettyPrinted)).data(using: .utf8, allowLossyConversion: true)!
    }
}
